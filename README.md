    ...
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
                <meta name="description" content="">
                        <link rel="icon" type="image/png" href="/user/themes/bootstrap/images/herzen-icon.png">

        <title>О кафедре | Кафедра информационных технологий и электронного обучения</title>
            ...
            <link href="/user/themes/bootstrap/css/custom_font.css" type="text/css" rel="stylesheet" />
...
<link href="/user/themes/bootstrap/css/fontawesome-all.css?0.1" type="text/css" rel="stylesheet" />
<link href="/user/themes/bootstrap/calendar/css/calendar.css?0.02" type="text/css" rel="stylesheet" />
<link href="/user/themes/bootstrap/calendar/css/custom_1.css?0.02" type="text/css" rel="stylesheet" />
<link href="/user/themes/bootstrap/calendar/css/demo.css?0.02" type="text/css" rel="stylesheet" />
<link href="/user/themes/bootstrap/css/home_page.css?0.02" type="text/css" rel="stylesheet" />
<link href="/user/themes/bootstrap/css/personal.css?0.01" type="text/css" rel="stylesheet" />
            ...
            <script src="/user/themes/bootstrap/js/jquery-3.3.1.min.js?0.01" type="text/javascript" ></script>
...
<script src="/user/themes/bootstrap/calendar/js/jquery.calendario.js?0.1" type="text/javascript" ></script>
<script src="/user/themes/bootstrap/calendar/js/modernizr.custom.63321.js?0.02" type="text/javascript" ></script>
<script src="/user/themes/bootstrap/js/pr_scripts.js?0.01" type="text/javascript" ></script>
...
<body>
		<header>
		<div class="container-fluid spiritual-background d-none d-md-block">
			...
			<div class="row">
			  ...
			  <div class="card border-0 special-card">
				<div class="card-body">
				<div class="media">
                        <a class="media-left waves-light d-none d-md-block">
                            <img class="rounded-circle img-logo my-2" src="/user/themes/bootstrap/images/herzen-logo-small-orig.png" alt="Test">
                        </a>
                        <div class="media-body d-none d-xl-block">
                            <h3 class="media-heading card-title">Герценовский университет</h3>
                            <h6 class="card-subtitle my-3">Российский Государственный Педагогический <br> Университет им. А. И. Герцена</h6>
							<hr class="bg-dark">
							<p class="card-text h3 mt-4" style="color : white; text-shadow : 2px 2px 3px black;"><strong>Кафедра информационных технологий <br> и электронного обучения</strong></p>							
                        </div>
		...
		<div class="container-fluid bg-dark d-md-none text-center pr-m-header"><br>
			<div class="container border border-3 border-light rounded-circle" style="background-color: rgba(245, 245, 245, .85)">
				<img src="/user/themes/bootstrap/images/herzen-logo-small-orig.png" class="img-fluid" style="max-width: 100%; height: auto;" alt="Responsive image">
				<div class="row">
					<div class="col-12" style="font-family: 'Montserrat', sans-serif;">
						<p class="h3 text-center">РГПУ им.<br>А. И. Герцена</p>
						<p class="h1 text-center"><strong>КИТЭО</strong></p>
					</div>
				</div>
			</div>
		</div>
		</header>				<nav class="navbar sticky-top navbar-expand-xl navbar-dark bg-dark">
		  ...
		  <div class="collapse navbar-collapse justify-content-md-center" id="mainNavBar">
			<ul class="navbar-nav">
			  <li class="nav-item mx-4">
				<a class="nav-link" href="http://ict.herzen.spb.ru">Главная</a>
			  </li>
			  <li class="nav-item mx-4">
				<a class="nav-link" href="http://ict.herzen.spb.ru/enrollee">Абитуриенту</a>
			  </li>
			  <li class="nav-item dropdown mx-4">
				<a class="nav-link dropdown-toggle active" href="#" id="dropdownC" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Кафедра <span class="sr-only">(current)</span></a>
				<div class="dropdown-menu" aria-labelledby="dropdownC">
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/department">Кафедра</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/department/about-us">О кафедре</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/department/employees/person/vlasova-e-z">Завкафедрой</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/department/employees">Сотрудники</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/department/graduates">Выпускники</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/department/development">Наши разработки</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/department/documents">Документы</a>
				</div>
			  </li>
			  <li class="nav-item dropdown mx-4">
				<a class="nav-link dropdown-toggle" href="#" id="dropdownD" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Учебная деятельность</a>
				<div class="dropdown-menu" aria-labelledby="dropdownD">
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/activity/educational-program">Образовательная программа</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/activity/e-learning">Электронное обучение</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/activity/digital-library">Электронная библиотека</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/activity/practice">Практика</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/activity/vkr">ВКР</a>
				</div>
			  </li>
			  <li class="nav-item dropdown mx-4">
				<a class="nav-link dropdown-toggle" href="#" id="dropdownS" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Наука</a>
				<div class="dropdown-menu" aria-labelledby="dropdownS">
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/science/research-work">НИР студентов</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/science/projects">Проекты</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/science/conferences">Конференции</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/science/publications">Публикации</a>
				</div>
			  </li>
			  <li class="nav-item mx-4">
				<a class="nav-link" href="http://ict.herzen.spb.ru/events">События</a>
			  </li>
			  <li class="nav-item mx-4">
				<a class="nav-link" href="http://ict.herzen.spb.ru/media-room">Медиазал</a>
			  </li>
			  <li class="nav-item mx-4">
				<a class="nav-link" href="http://ict.herzen.spb.ru/partners">Партнёры</a>
			  </li>
			  <!--<li class="nav-item mx-4">
				<a class="nav-link dropdown-toggle" href="#" id="dropdownS" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Сведения об образовательной организации</a>
				<div class="dropdown-menu" aria-labelledby="dropdownS">
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/common">Основные сведения</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/struct">Структура и органы управления образовательной организацией</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/document">Документы</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/education">Образование</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/eduStandarts">Образовательные стандарты</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/employees">Руководство. Научно-педагогический состав</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/objects">Материально-технческое обеспечение и оснащенность образовательного процесса</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/grants">Стипендии и иные виды материальной поддержки</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/paid_edu">Платные образовательные услуги</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/budget">Финансово-хозяйственная деятельность</a>
				  <a class="dropdown-item" href="http://ict.herzen.spb.ru/sveden/vacant">Вакантные места для приема (перевода)</a>
				</div>
			  </li> -->
			</ul>
		  </div>
